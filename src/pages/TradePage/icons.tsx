/** Иконка карандаша (режим редактирования) */
...
/** Иконка глаза перечёркнутого (контент скрыт) */
...
/** Иконка папки / перенос в категорию */
export const FolderMoveIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    width="18"
    height="18"
